export default function Footer() {
  return (
    <footer className="bg-brown-primary text-cream py-12 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h3 className="font-serif text-2xl font-bold mb-4">CLEF Music</h3>
        ...
        <div className="border-t border-brown-light mt-8 pt-8 text-center text-cream/60">
